...
# abd
#https://www.kaggle.com/c/homesite-quote-conversion/forums/t/18239/converting-the-xgb-stop-r-0-96817-to-python
...
param =     {
    ...
    #'gamma':1 ,#gamma [default=0] range: [0,鈭瀅
    'max_depth'           :6, #max_depth [default=6] range: [1,鈭瀅
    #'min_child_weight':3,  #default=1]range: [0,鈭瀅
...
sample.to_csv('pywp/xgbr6000withgoldenfea.csv', index=False)
